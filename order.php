...
if (isset($_POST['submit'])){
	if(!empty($_SESSION['user_info'])) {
        ...
        $qty5 = isset($_POST['qty5']) ? (int)$_POST['qty5'] : 0;
        $qty6 = isset($_POST['qty6']) ? (int)$_POST['qty6'] : 0;
        $qty7 = isset($_POST['qty7']) ? (int)$_POST['qty7'] : 0;
        $qty8 = isset($_POST['qty8']) ? (int)$_POST['qty8'] : 0;
        $qty9 = isset($_POST['qty9']) ? (int)$_POST['qty9'] : 0;
